...
export class InMemoryWebSocketClient extends EventEmitter implements WebSocketClient {
	...
	public rawListeners(_eventName: string | symbol): (GenericFunction | WrappedFunction)[] {
		throw new Error('Method not implemented.');
	}
	...
	public prependOnceListener(_eventName: string | symbol, _listener: GenericFunction): this {
		throw new Error('Method not implemented.');
	}
	public removeAllListeners(_eventName?: string | symbol): this {
		throw new Error('Method not implemented.');
	}
	public removeListener(_eventName: string | symbol, _listener: GenericFunction): this {
		throw new Error('Method not implemented.');
	}
